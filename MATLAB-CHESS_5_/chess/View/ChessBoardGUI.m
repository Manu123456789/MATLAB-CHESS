            ...
            if this.isReviewMode
                ...
                if this.isRewound()
                    ...
                    if this.reviewVariationActive
                        ...
                        msg = sprintf(['Review  --  variation from move %d of %d  --  ' ...
                            '%s to move  (Prev/Next discards variation)'], ...
                            this.rewindIndex, nHist, sideStr);
                    else
                        msg = sprintf(['Review  --  viewing move %d of %d  --  ' ...
                    ...
                    if this.reviewVariationActive
                        sideStr = 'White';
                        if this.gameController.whoPlays() == 'b'; sideStr = 'Black'; end
                        msg = sprintf(['Review  --  variation from final position  --  ' ...
                            '%s to move'], sideStr);
                    else
                        msg = 'Review  --  final position  --  click any piece, or use < > to step through history';
                    end
                end
